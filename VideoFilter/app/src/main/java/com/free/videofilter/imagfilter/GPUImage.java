...
public class GPUImage {
     ...
     */
    public void setUpCamera(final android.hardware.Camera camera) {
     ...
     */
    public void setUpCamera(final android.hardware.Camera camera, final int degrees, final boolean flipHorizontal,
