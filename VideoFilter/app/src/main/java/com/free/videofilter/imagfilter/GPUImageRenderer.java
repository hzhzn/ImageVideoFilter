...
import jp.co.cyberagent.lansongsdk.gpuimage.util.*;
//import jp.co.cyberagent.lansongsdk.gpuimage.*;
//import jp.co.cyberagent.lansongsdk.gpuimage.util.*;

import static jp.co.cyberagent.lansongsdk.gpuimage.util.TextureRotationUtil.*;
...
public class GPUImageRenderer implements Renderer, PreviewCallback {
    ...
    public void setUpSurfaceTexture(final android.hardware.Camera camera) {
        runOnDraw(new Runnable() {
            @Override
            public void run() {
